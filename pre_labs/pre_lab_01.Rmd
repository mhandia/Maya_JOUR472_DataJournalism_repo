...
last_name is a chr column / data type. Probably represents the last name of the candidate or person who gave donation to a candidate
...
maryland_winred_contributions |>
  ...
  summarise(
    # create new column with count_contribs that equals the number of rows (number of donations) that have the same date value including that one
    count_contribs = n()
  )
```
